...
const userValidationRules = [
  ...
  body("phone")
    ...
    .withMessage(
      "Phone number must be in the format +234[70|80|81|90|91]XXXXXXX (e.g., +2348012345678)"
    ),
...
const updateUserValidation = [
  param("id")
    ...
    ...userValidationRules.map((rule) => {
      if (!rule || !rule.builder || !rule.builder.fields) return rule;
      const fieldName = rule.builder.fields[0];
      if (fieldName === "password") return rule;
